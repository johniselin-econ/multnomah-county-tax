...
if ${use_parallel} == 1 {
	...
	** Run parallel estimation
	...
	parallel, prog(parallel_otherout_wrapper run_otherout_table): parallel_otherout_wrapper
...
** Preferred: Urban 95% COVID match + covariates + excl 2020
replace preferred = 1 if 									///
	sample == "sample_urban75_covid" &						///
	controls == 1 &											///
	exclusion == 1
